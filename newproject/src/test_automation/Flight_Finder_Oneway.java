...
public class Flight_Finder_Oneway {
	public static void main(String[] args){
		...
		driver.findElement(By.xpath("//*[@name='tripType'][@value='oneway']")).click();
		...
		arrivingin.selectByVisibleText("Ps         aris");
		...
		WebElement radiobtn1 = driver.findElement(By.xpath("//*[@name='servClass'][@value='First']"));
		radiobtn1.click();
